...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Faktor panas akibat Matahari, albedo, dan Bumi membutuhkan perhitungan faktor gerhana \textit{node} satelit ($F_{e,i}$), \textit{view factor node} satelit ke Bumi ($F_{i,E}$), dan faktor albedo satelit ($F_a$)
    \end{itemize}
