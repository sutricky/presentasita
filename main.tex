...
\end{frame}
\begin{frame}
  \frametitle{Hasil Pemodelan Termal Satelit LAPAN-A3 - Grafik Suhu \textit{Node} Satelit vs Waktu 19 Mei 2018}
  \begin{columns}[T]
    \column{0.5\textwidth}
      \begin{figure}
...
\begin{frame}
  \frametitle{Hasil Pemodelan Termal Satelit LAPAN-A3 - Grafik Suhu \textit{Node} Satelit vs Waktu 20 Mei 2018}
  \begin{columns}[T]
    \column{0.5\textwidth}
      \begin{figure}
