...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
    \begin{itemize}
        \item LAPAN-A3 adalah satelit hasil kerja sama antara Lembaga Penerbangan dan Antariksa Nasional (LAPAN) dengan Institut Pertanian Bogor (IPB) yang diluncurkan pada 2016 \cite{hasbi2013}
